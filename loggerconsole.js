...
class LoggerConsole {
  constructor(logger, settings = {}) {
    ...
    if (this.settings && this.settings.disableFormatting) {
      if (Meteor.isServer) {
        this.cons = {
          error(obj, message) {
        ...
        this.cons = {
          ...
          debug(obj, message) {
            if (helpers.isFunction(console.debug)) {
              console.debug(message, '', obj.data);
            } else {
              console.log(message, '', obj.data);
            }
          },
          trace(obj, message) {
            if (helpers.isFunction(console.trace)) {
              console.trace(message, '', obj.data);
            } else {
              console.log(message, '', obj.data);
            }
          },
      ...
      if (this.settings && this.settings.disableFormatting) {
        if (this.settings.format) {
          ...
          if (Meteor.isServer) {
            ...
            _message = '[' + obj.level + ': ' + obj.message + ']';
          }
        }
      } else {
        if (this.settings.format) {
